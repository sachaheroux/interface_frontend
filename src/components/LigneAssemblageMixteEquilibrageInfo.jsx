export default function LigneAssemblageMixteEquilibrageInfo() {
  return (
    <div style={{
      ...
      <h3 style={{ marginTop: 0, color: "#8b5cf6", fontSize: "1.2rem" }}>Équilibrage de Ligne Mixte</h3>
      ...
      <div style={{ marginBottom: "1rem" }}>
        <h4 style={{ color: "#8b5cf6", marginBottom: "0.5rem", fontSize: "1rem" }}>Spécificités ligne mixte</h4>
      ...
      <div style={{ marginBottom: "1rem" }}>
        <h4 style={{ color: "#8b5cf6", marginBottom: "0.5rem", fontSize: "1rem" }}>Calcul des temps pondérés</h4>
        <p style={{ marginBottom: "0.5rem" }}>
      ...
      <div style={{ marginBottom: "1rem" }}>
        <h4 style={{ color: "#8b5cf6", marginBottom: "0.5rem", fontSize: "1rem" }}>Cas d'usage typiques</h4>
        <ul style={{ paddingLeft: "1.2rem", margin: "0.5rem 0" }}>
      ...
      <div style={{ marginBottom: "1rem" }}>
        <h4 style={{ color: "#8b5cf6", marginBottom: "0.5rem", fontSize: "1rem" }}>Différences avec ligne simple</h4>
