...
function LigneAssemblageLPTForm() {
  ...
  const handleSubmit = () => {
    ...
    try {
      ...
      fetch(`${API_URL}/ligne_assemblage/lpt`, {
        method: "POST",
        ...
        .then(data => {
          ...
          return fetch(`${API_URL}/ligne_assemblage/lpt/chart`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload)
          });
  ...
  return (
    <div className={styles.container}>
      <h2 className={styles.title}>Ligne d'assemblage - LPT (Longest Processing Time)</h2>
      ...
      {result && (
        <div className={styles.results}>
          <h3>Résultats de l'équilibrage LPT</h3>
          ...
          {chartUrl && (
            <div className={styles.ganttContainer}>
              <h4>Graphiques d'analyse LPT</h4>
              <img
                src={chartUrl}
                alt="Graphiques LPT"
