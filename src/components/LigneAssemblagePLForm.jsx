...
function LigneAssemblagePLForm() {
  ...
  const handleSubmit = () => {
    ...
    try {
      ...
      fetch(`${API_URL}/ligne_assemblage/pl`, {
        method: "POST",
        ...
        .then(data => {
          ...
          return fetch(`${API_URL}/ligne_assemblage/pl/chart`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload)
          });
  ...
  return (
    <div className={styles.container}>
      <h2 className={styles.title}>Ligne d'assemblage - PL (Programmation Linéaire Optimale)</h2>
      ...
      <button 
        ...
        disabled={isLoading}
      >
        {isLoading ? "Optimisation en cours..." : "Lancer l'optimisation PL"}
      </button>
      ...
      {result && (
        <div className={styles.results}>
          <h3>Résultats de l'optimisation PL</h3>
          
          <div className={styles.optimizationStatus}>
            <strong>Statut d'optimisation :</strong> 
            <span style={{ 
              color: result.optimization_status === 'Optimal' ? '#10b981' : '#ef4444',
              fontWeight: 'bold',
              marginLeft: '0.5rem'
            }}>
          ...
          <div className={styles.metricsGrid}>
            ...
            <div><strong>Écart à l'optimal :</strong> {result.metrics.ecart_optimal}%</div>
          ...
          {chartUrl && (
            <div className={styles.ganttContainer}>
              <h4>Graphiques d'analyse PL (Solution Optimale)</h4>
              <img
                src={chartUrl}
